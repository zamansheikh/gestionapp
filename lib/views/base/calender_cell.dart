...
class _CalendarCellState extends State<CalendarCell> {
  final Color _pastBookingColor = const Color(0xFF6A6A6A);
  final Color _runningBookingColor = const Color(0xFFD80665);
  final Color _futureBookingColor = const Color(0xFFFFACA5);
  final Color _todayColors = const Color(0xFFC8779C);
